\section{Dinur's polynomial-method solver} \label{sec:dinur}
...
\begin{figure}[ht]
    ...
    \begin{alg}
        ...
        \label{alg:output}
        \KwIn{$\Tilde{\mathcal{P}}_k$: $\{r_i(\mathbf{x})\}_{i = 0}^{\ell - 1}$, $n$: Integer, $n_1$: Integer, $w$: Integer}
...
\begin{figure}[t]
    ...
    \begin{alg}
        ...
        \label{alg:uvalues}
        \KwIn{$\Tilde{\mathcal{P}}_k$: $\{r_i(\mathbf{x})\}_{i = 0}^{\ell - 1}$, $n_1$: Integer, $w$: Integer}
