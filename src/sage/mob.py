...
def mob_transform(sol, vars, degree=Infinity):
  f = _f_expand(_sage_const_0 , vars, sol, degree)
...
def _f_expand(lvl, vars, sol, degree):
    ...
    if lvl == len(vars):
        ...
        tmp0 = _f_expand(lvl + _sage_const_1 , alt(_sage_const_0 ), sol, degree)
        tmp1 = _f_expand(lvl + _sage_const_1 , alt(_sage_const_1 ), sol, degree)
